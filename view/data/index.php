...
$data['data'] = [
    ...
    "sub-header" => [
        "text" => "Desenvolvimento Automatizado"
    ],
    "sub-tag" => [
        "text" => "O Singular Framework tem como princípio automatizar tarefas de desenvolvimento a fim de melhorar a produtividade. Utilizando como base, metadados que auxiliam na geração de códigos"
    ],
    "sub-img" => [
        "attr" => [
